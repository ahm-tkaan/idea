const Map<String, Map<String, Map<String, List<String>>>> konular = {
  '9. Sınıf': {
    'Matematik': {
      'Sayılar': [
    ...
    'Biyoloji' : {
      ...
      'Yaşam': [
        ...
        'Üç Üst Âlem (Domain) Sisteminde Yer Alan Canlılar ve Genel Özellikleri (Bakteriler, Arkeler, Ökaryotlar)',
        'Biyoçeşitlilik',
      ],
      'Organizasyon': [
        ...
        'Sitoplazma',
        'Sitoplazmik Yapılar',
        'Organeller ve Çekirdek',
        'Hücre Zarından Madde Geçişleri',
        'Hücreden Doku',
        'Organ ve Sistemlerin Organizasyonu',
      ],
    },
    ...
    'İngilizce': {
      ...
      'Emergency and Health Problems': [
        'Acil Durum ve Sağlık Sorunları',
      ],
  ...
  '11. Sınıf': {
    ...
    'Fizik': {
      'Kuvvet ve Hareket': [
        ...
        'Serbest Düşme',
        'Limit Hız',
        'Düşey Doğrultuda Atış Hareketi',
        'İki Boyutta Hareket',
        'Yatay Atış Hareketi',
        'Düşey Atış Hareketi',
        'Enerji ve Hareket',
    ...
    'Felsefe': {
      ...
      '3. Ünite: 15. Yüzyıl – 17. Yüzyıl Felsefesi': [
        ...
        '15. Yüzyıl – 17. Yüzyıl Filozoflarının Düşünce ve Argümanlarını Değerlendirme',
      ],
      '4. Ünite: 18. Yüzyıl – 19. Yüzyıl Felsefesi': [
        ...
        '18. Yüzyıl – 19. Yüzyıl Filozoflarının Düşünce ve Argümanlarını Değerlendirme',
      ],
      '20. Yüzyıl Felsefesi': [
        ...
        '20. Yüzyıl Filozoflarının Düşünce ve Argümanlarını Değerlendirme',
        '20 ve 21. Yüzyıl Felsefecileri ve Yaşadıkları Coğrafya',
      ],
    },
  },
  ...
  '12. Sınıf': {
    ...
    'Fizik': {
      ...
      'Fizikte Başarı İçin İpuçları': [
        'Konuların düzenli tekrarı ve çok sayıda soru çözümü önemlidir.',
        'Düzenli çalışma, deney yapma ve bolca pratik, fizik dersinde başarı için anahtar unsurlardır.',
      ],
      'İlgili Diğer İçerikler': [
        '12. Sınıf Fizik Ortak Sınav Konu ve Soru Dağılımları',
    ...
    'Tarih': {
      ...
      'Milli Mücadele': [
        'Kuva’yı Milliye’nin Oluşumundan Büyük Millet Meclisine',
